...
i2c_master_init(void)
{
    ...
    for (i = 0; i < 28; i++) {
        i2c_master_setDC(1, 0);
        i2c_master_wait(I2C_DELAY);	// sda 1, scl 0
        i2c_master_setDC(1, 1);
        i2c_master_wait(I2C_DELAY);	// sda 1, scl 1
    }
...
i2c_master_start(void)
{
    ...
    i2c_master_wait(I2C_DELAY);	// sda 0, scl 1
}
...
i2c_master_stop(void)
{
    ...
    i2c_master_wait(I2C_DELAY);	// sda 0
    i2c_master_setDC(0, 1);
    i2c_master_wait(I2C_DELAY);	// sda 0, scl 1
    i2c_master_setDC(1, 1);
    i2c_master_wait(I2C_DELAY);	// sda 1, scl 1
...
i2c_master_setAck(uint8 level)
{
    ...
    i2c_master_wait(I2C_DELAY);	// sda level, scl 0
    i2c_master_setDC(level, 1);
    i2c_master_wait(I2C_DELAY * 2);	// sda level, scl 1
    i2c_master_setDC(level, 0);
    i2c_master_wait(I2C_DELAY);	// sda level, scl 0
    i2c_master_setDC(1, 0);
    i2c_master_wait(I2C_DELAY);
